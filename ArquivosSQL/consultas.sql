...
SELECT TP.Tipo FROM Tipo_Pessoa TP WHERE TP.CPF = 12345678901;

SELECT * FROM INFORMANTE I WHERE I.CPF = 21436587095;


DELETE FROM TIPO_PESSOA I WHERE I.CPF = 21436587095;
